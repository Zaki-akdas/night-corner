...
import { Bike, CheckCircle2, ChevronDown, KeyRound, Loader2, Phone } from "lucide-react";
 ...
 * Marking an order Delivered requires the delivery PIN the customer gives at
 * handover. The compact variant (dashboard cards) keeps the PIN form
    ...
    <div className="space-y-2">
      ...
      {canDeliver && (
        <div className="space-y-2">
          ...
          {/* Telegraph the requirement even before the form expands. */}
          {!showPod && (
            <p className="text-xs text-slate-400">
              Requires the customer&apos;s delivery PIN
            </p>
          )}
